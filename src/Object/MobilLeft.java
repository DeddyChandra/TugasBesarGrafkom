...
public class MobilLeft {
	...
	public MobilLeft(Color color,int panjang, int x, int y, Graphics2D g2d) {
		this.color = color;
...
//		drawMobilWheel();
	...
	public void drawMobilTop() {
		...
		mobilTop.lineTo(x+130,y-95);
		mobilTop.lineTo(x+50,y-95);
		mobilTop.lineTo(x+20, y-65);
		mobilTop.moveTo(x+130,y-65);
		mobilTop.lineTo(x+130+10,y-95);
		mobilTop.lineTo(x+130+10,y-125);
		mobilTop.lineTo(x+50+10,y-125);
		mobilTop.lineTo(x+20+10, y-95);
		mobilTop.lineTo(x+20, y-65);
		mobilTop.moveTo(x+130,y-95);
		mobilTop.lineTo(x+130+10,y-125);
		mobilTop.moveTo(x+50+10,y-125);
		mobilTop.lineTo(x+50,y-95);
	...
	public void drawMobilWindow() {
		...
		mobilWindow.moveTo(x+panjang-30,y-65);
		mobilWindow.lineTo(x+panjang-30,y-90);
		mobilWindow.lineTo(x+panjang-60,y-90);
		mobilWindow.lineTo(x+panjang-60,y-65);
		mobilWindow.lineTo(x+panjang-30,y-65);
		
		mobilWindow.moveTo(x+30,y-65);
		mobilWindow.lineTo(x+80,y-65);
		mobilWindow.lineTo(x+80,y-90);
		mobilWindow.lineTo(x+55,y-90);
		mobilWindow.lineTo(x+30,y-65);
		
		mobilWindow.moveTo(x+25, y-70);
		mobilWindow.lineTo(x+35, y-100);
		mobilWindow.lineTo(x+55, y-120);
		mobilWindow.lineTo(x+45, y-90);
		mobilWindow.lineTo(x+25, y-70);
	}
