...
public class KeretaBody {
	...
	public KeretaBody(Color bodyColor, Color lineColor, int x, int y, Graphics2D g2d) {
		this.x = x;
		this.y = y;
		this.g2d = g2d;
...
//		this.g2d.setColor(Color.white);
	...
	public void drawLine(){
		keretaLine.moveTo(x+9, y-53);
		keretaLine.lineTo(x+9, y-50);
		keretaLine.lineTo(x+287, y-50);
		keretaLine.lineTo(x+289, y-53);
		
		keretaLine.moveTo(x+10, y-47);
		keretaLine.lineTo(x+11, y-44);
		keretaLine.lineTo(x+288, y-44);
		keretaLine.lineTo(x+290, y-47);
...
//		keretaLine.lineTo(x+281,y-44);
	...
	public void drawWindows() {
		...
		keretaWindows.lineTo(x+165, y-63);
		keretaWindows.lineTo(x+192, y-63);
		keretaWindows.lineTo(x+190, y-90);
		keretaWindows.lineTo(x+163, y-90);
		
		keretaWindows.moveTo(x+198, y-90);
		keretaWindows.lineTo(x+200, y-63);
		keretaWindows.lineTo(x+239, y-63);
		keretaWindows.lineTo(x+237, y-90);
		keretaWindows.lineTo(x+198, y-90);
		
		keretaWindows.moveTo(x+244, y-90);
		keretaWindows.lineTo(x+246, y-63);
		keretaWindows.lineTo(x+277, y-63);
		keretaWindows.lineTo(x+275, y-90);
		keretaWindows.lineTo(x+244, y-90);
	}
	...
	public void drawKeretaLower() {
		...
		keretaLower.lineTo(x+294, y-21);
		keretaLower.lineTo(x+292, y-34);
		
		keretaLower.moveTo(x+292,y-34);
		keretaLower.lineTo(x+318,y-65);
		keretaLower.lineTo(x+321,y-50);
		keretaLower.lineTo(x+294, y-21);
	}
	...
	public void drawKeretaBody() {
		...
		keretaBody.lineTo(x+292,y-34);
		keretaBody.lineTo(x+280,y-98);
		keretaBody.lineTo(x,y-98);
		
		keretaBody.lineTo(x+24,y-129);
		keretaBody.lineTo(x+304,y-129);//
		keretaBody.lineTo(x+280,y-98);
		
		keretaBody.moveTo(x+292,y-34);
		keretaBody.lineTo(x+318,y-65);
		keretaBody.lineTo(x+304,y-129);
		keretaBody.lineTo(x+280,y-98);
	...
	public void draw() {
		...
		g2d.drawImage(img, x+87, y-128, null); 
	}
}
